    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-xlg-12 col-md-12">
            <div class="row">
                <div class="col-lg-12 col-xlg-12 col-md-12">
                    <div class="card">
                        <div class="card-block p-l-20">
                            <h3>Search Places to Review</h3>
                            <hr>
                            ...
                            <div class="card-block" style="width:95%;">
                                {!!Form::open(['action' => 'PagesController@reviewSearch', 'method' => 'POST'])!!}
                                    ...
                                    <div class="single-widget input-group mb-3 " id="mc_embed_signup">
                                        {{Form::text('key', '' , [ 'class' => 'form-control', 'placeholder' => 'Search places', 'onfocus' => 'this.placeholder = \'\'', 'onblur' => 'this.placeholder = \'Search places\'', 'aria-label' => 'Search', 'aria-describedby' => 'searchBtn' , 'style'=>'border: 1px solid #b3b3b3;']) }}
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">  
                        <div class="card">
                            <div class="card-block p-t-10 p-l-10">
                                <h4>Results</h4>
                                <hr> 
                                <p class="card-search">Showing the businesses that match the search "{{$key}}". We found <a href="#bOrg">{{ count($brands) }} </a>such Places</p>
                                @if(count($brands) > 0)
                                    ...
                                    <div class="m-t-10 col-md-4 p-l-0 p-r-0">
                                        ...
                                        <div class="col-md-7 col-xs-12 p-l-0 p-r-0 ">
                                            ...
                                            <p><span><a href="#" class="link"> Add New</a></span></p>
                                        </div>
                                    </div>
